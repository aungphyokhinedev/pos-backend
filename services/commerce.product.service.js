...
const commerceProductModel = require("../models/commerce.product.model");
...
module.exports = {
	...
	settings: {
		...
		populates: {
			...
			"discount": {
				action: "v1.commercediscount.get",
				params: {
					fields: "name _id"
				}
            },
            "category": {
				action: "v1.commercecategory.get",
				params: {
					fields: "name _id"
				}
			},
